...
class ObstacleType {
  ...
  static final cactusSmall = ObstacleType._internal(
    ...
    collisionBoxes: <CollisionBox>[
      CollisionBox(position: Vector2(5.0, 7.0), size: Vector2(10.0, 54.0)),
      CollisionBox(position: Vector2(5.0, 7.0), size: Vector2(12.0, 68.0)),
      CollisionBox(position: Vector2(15.0, 4.0), size: Vector2(14.0, 28.0))
    ]
  );
  ...
  static final cactusLarge = ObstacleType._internal(
      ...
      minSpeed: 0.0,
      collisionBoxes: <CollisionBox>[
        CollisionBox(position: Vector2(0.0, 12.0), size: Vector2(14.0, 76.0)),
        CollisionBox(position: Vector2(8.0, 0.0), size: Vector2(14.0, 98.0)),
        CollisionBox(position: Vector2(13.0, 10.0), size: Vector2(20.0, 76.0))
      ]
  );
